...
class BiohackTextTheme extends CompanyTextTheme {
  ...
  TextTheme buildBaseTextTheme(Color displayColor, Color bodyColor) {
    final currentTextTheme = TextTheme(
      headline1:
          GoogleFonts.righteous(fontSize: 97, fontWeight: FontWeight.w300, letterSpacing: -1.5),
      headline2:
          GoogleFonts.righteous(fontSize: 61, fontWeight: FontWeight.w300, letterSpacing: -0.5),
      headline3: GoogleFonts.righteous(fontSize: 48, fontWeight: FontWeight.w400),
      headline4:
          GoogleFonts.righteous(fontSize: 34, fontWeight: FontWeight.w400, letterSpacing: 0.25),
      headline5: GoogleFonts.righteous(fontSize: 24, fontWeight: FontWeight.w400),
      headline6:
          GoogleFonts.righteous(fontSize: 20, fontWeight: FontWeight.w500, letterSpacing: 0.15),
      subtitle1:
          GoogleFonts.righteous(fontSize: 16, fontWeight: FontWeight.w400, letterSpacing: 0.15),
      subtitle2:
          GoogleFonts.righteous(fontSize: 14, fontWeight: FontWeight.w500, letterSpacing: 0.1),
      bodyText1:
          GoogleFonts.righteous(fontSize: 16, fontWeight: FontWeight.w400, letterSpacing: 0.5),
      bodyText2:
          GoogleFonts.righteous(fontSize: 14, fontWeight: FontWeight.w400, letterSpacing: 0.25),
      ...
      overline:
          GoogleFonts.righteous(fontSize: 10, fontWeight: FontWeight.w400, letterSpacing: 1.5),
    ).apply(
      displayColor: displayColor,
      bodyColor: bodyColor,
    );
