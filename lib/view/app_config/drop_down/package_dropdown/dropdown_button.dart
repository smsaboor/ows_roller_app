...
class FbsDropdownButton<T> extends StatefulWidget {
  ...
  ///
  /// If the [onChanged] callback is null or the list of [FbsDropdownButton.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [FbsDropdownButton.disabledHint] widget if it is non-null.
  /// If [FbsDropdownButton.disabledHint] is also null but [FbsDropdownButton.hint] is
  /// non-null, [FbsDropdownButton.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  @override
  State<FbsDropdownButton<T>> createState() => FbsDropdownButtonState<T>();
}

class FbsDropdownButtonState<T> extends State<FbsDropdownButton<T>>
  ...
  @override
  void didUpdateWidget(FbsDropdownButton<T> oldWidget) {
...
/// A [FormField] that contains a [FbsDropdownButton].
///
/// This is a convenience widget that wraps a [FbsDropdownButton] widget in a
/// [FormField].
///
...
/// See also:
///
///  * [FbsDropdownButton], which is the underlying text field without the [Form]
///    integration.
class DropdownButtonFormField2<T> extends FormField<T> {
  /// Creates a [FbsDropdownButton] widget that is a [FormField], wrapped in an
  /// [InputDecorator].
  ///
              ...
              builder: (BuildContext context, StateSetter setState) {
                return InputDecorator(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: FbsDropdownButton._formField(
