...
class BodyTransactionHistory extends StatelessWidget {
  const BodyTransactionHistory({Key? key}) : super(key: key);
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              Spacer(),
              Text('Type',style: TextStyle(fontSize: 15,color: Colors.white),),
              Spacer(),
